...
bindsym $mod+button4 --whole-window --border	exec --no-startup-id pactl set-sink-volume @DEFAULT_SINK@ +10%
bindsym $mod+button5 --whole-window --border	exec --no-startup-id pactl set-sink-volume @DEFAULT_SINK@ -10%
